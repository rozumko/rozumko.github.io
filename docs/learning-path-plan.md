...
5.1. Карти 1, 3, 4 класів (модель точки вже готова; орієнтир розподілу — карта
...
- Позиціювання карти vs поточний home.html: шлях замінює вибір клас+трек чи
  співіснує поруч на перехідний період? (пропозиція: співіснування до готовності
  карт усіх класів, потім шлях стає головним екраном «Я вдома»).
