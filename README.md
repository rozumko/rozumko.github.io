...
| **Домашній режим / Rozumko Club** | Батьківський шлях: коротке демо, згода дорослого, зрозумілий звіт, регулярна домашня практика й підписка. | 🔵 У планах: немає батьківських акаунтів, оплат, дитячих профілів чи consent |
...
самостійні шкільні місії на `/school` і класна гра в стилі Kahoot: вчитель
створює код, учні приєднуються анонімно з аватаром і прізвиськом, а вчитель
бачить лідерборд без ПІБ.
