...
відповідей не потрапляють у браузер) та браузерні сертифікати/дипломи.

Продуктове бачення організоване навколо двох ширших поверхонь, які поки що
**в розробці** (детально й з позначками `[PLANNED]` — у
[architecture.md](./docs/architecture.md)):

| Поверхня | Призначення | Стан |
|---|---|---|
| **Шкільний режим** | Простий класний режим для вчителів і груп, відокремлений від батьківських оплат і дитячих персональних даних. | 🟡 Вхідна сторінка є; окремий анонімний класний бекенд — у планах |
| **Домашні місії** | Батьківський шлях для корисного екранного часу, основ ШІ та поступового прогресу. | 🔵 У планах: немає батьківських акаунтів, оплат, дитячих профілів чи consent |
