...
| **Домашній режим / Rozumko Club** | Батьківський шлях: коротке демо, згода дорослого, зрозумілий звіт, регулярна домашня практика й підписка. | ✅ Працює: `/home`, lead + consent, дитячий профіль, серверний звіт, entitlement і gated Club practice; оплати/provider checkout — planned |
