...
const COPY: Record<Exclude<ProductSurface, 'school'>, {
  ...
  home: {
    ...
    description: 'Зараз ми зосередилися на випробуванні класних ігор разом із учителями.',
  ...
  olympiad: {
    ...
    note: 'Після завершення шкільного випробування ми оголосимо новий сезон на цій самій сторінці.',
  },
}
